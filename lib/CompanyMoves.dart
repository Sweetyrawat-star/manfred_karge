...
class CompanyMoves extends StatefulWidget {
  final int id;
CompanyMoves(
      {this.id,});
  @override
  _CompanyMovesState createState() => _CompanyMovesState();
}

class _CompanyMovesState extends State<CompanyMoves> {
   Future<ServicesModel> getCompanyMoves() async {
    try{
      final url = "https://manfredkarger.ouctus-platform.com/api/service/details/${widget.id}";
                         ...
                         Container(
                           ...
                           decoration: BoxDecoration(
                             image: DecorationImage(
                               image: AssetImage(
                                 "assets/image/beispiel-firmenumzug.jpg",
                               ),
                               fit: BoxFit.cover,
                             ),
                           ),),
