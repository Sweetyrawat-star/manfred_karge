...
import 'Model/TermAndConditionModel.dart';
        ...
        children: [
          ...
          OfflineBuilder(
            connectivityBuilder: (
              ...
              return connected? FutureBuilder<TermAndCondition>(
                future: ApiHandler.getTermsAndCondition(),
                builder: (context, snapshot){
                  if(snapshot.hasData){
                    var document = parse( snapshot.data.data.content);
                    return Column(
                        children: [
                          Text(
                              document.body.text,
