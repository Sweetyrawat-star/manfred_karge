...
class ClearingOut extends StatefulWidget {
  final int id;
  ClearingOut(
      {this.id,});
  @override
  _ClearingOutState createState() => _ClearingOutState();
}

class _ClearingOutState extends State<ClearingOut> {
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              image: NetworkImage(
                                  ApiHandler.url+snapshot.data.data.serviceIcon
                              ),
                              fit: BoxFit.cover,
                            ),
                          ),),
